            ...
            <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 bg-color1 px-4 sm:gap-x-6 sm:px-6 lg:px-8">
              ...
              <div className="flex flex-1 gap-x-4 justify-end lg:gap-x-6">
                <div className="flex items-center gap-x-4 lg:gap-x-6">
                  ...
                  <Menu as="div" className="flex flex-wrap gap-1 justify-end">
          ...
          <div>
            <main>
              ...
              <div className="pl-4 pr-4 lg:pr-0">
                <div className="w-full min-h-[800px] border bg-red=500 border-gray-400 rounded-2xl p-5 lg:px-10 lg:py-5 bg-white">
                  <Outlet />
                </div>
              </div>
            </main>
