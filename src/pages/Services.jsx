    ...
    <>
      <div className="flex items-center justify-between">
        ...
        <Link to="/edit-services">
          <button className="w-[120px] bg-color4 hover:bg-color3 rounded-lg  py-1 px-3 text-white text-sm flex items-center justify-center">
            ویرایش خدمات
          </button>
        </Link>
      </div>
      <div className="w-full min-h-[400px] rounded-2xl bg-white border border-[#dbdbdb] mt-10 flex flex-col lg:flex-row py-2 px-4 lg:px-5 gap-4">
        <div className="w-full lg:w-1/3">
          <p className="text-color3 text-sm">افزودن نقش کاربران</p>
          <form action="">
              ...
              <table className="w-full text-[#b4b4b4] text-[14px]">
                ...
                <thead className="border-b border-[#D9D9D9] bg-[#FBFAF6] rounded-t-lg">
                  <tr>
                    ...
                    <th className="text-center">نامک</th>
                    <th className="text-center">اجرا</th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    <td className="py-4">
                      <div className="flex items-center justify-center gap-2">
                        <input
                          ...
                          className="w-3 h-3 rounded-full border border-gray-400 appearance-none checked:bg-yellow-600 focus:outline-none"
                        />
                        <span className="pr-1">داروخانه</span>
                      </div>
                    </td>
                    <td className="py-4">-</td>
                    <td className="py-4">داروخانه</td>
                      ...
                      <div className="flex flex-col items-center justify-center gap-1">
                        <div className="flex items-center justify-center gap-2">
                          <input
                            ...
                            className="w-3 h-3 rounded-full border border-gray-400 appearance-none checked:bg-yellow-600 focus:outline-none"
                          />
                          <span className="pr-1">آمبولانس</span>
                        </div>
