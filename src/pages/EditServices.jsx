  ...
  return (
    <>
      <p className="text-[#000] text-[18px] lg:text-[21px]">
        اطلاعات خدمات خود را وارد نمایید
      </p>
        ...
        <div className="w-full lgw-9/12">
          ...
          <div>
            ...
            <div className="flex flex-col items-start justify-between mt-3">
              <span className="text-color4 text-[15px] lg:w-[130px] py-2">
                {" "}
                توضیحات سئو :
              </span>
              <textarea className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 pr-1 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 h-[150px]"></textarea>
            </div>
          ...
          <div className="w-[204px] h-[212px] bg-[#f9f9f9] border border-[#ddd] rounded-lg relative">
            ...
            <div>
              ...
              <div className="mt-4 w-full text-[#878787] text-[10px] px-4 flex flex-col gap-3">
                <div>وضعیت : پیش نویس ویرایش</div>
                <div>قابلیت مشاهده: عمومی ویرایش</div>
                <div>انتشار فوری ویرایش</div>
                <div>سئو : در دسترس نمیباشد</div>
              </div>
            </div>
