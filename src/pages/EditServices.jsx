      ...
      <div className="flex flex-col lg:flex-row mt-12 gap-6">
        <div className="w-full lgw-9/12">
            ...
            <div className="flex items-center justify-between lg:justify-start mt-3">
              <span className="text-[#b4b4b4] text-[15px] lg:w-[114px]"> خدمات :</span>
              <input
                type="text"
            ...
            <div className="flex items-center justify-between lg:justify-start mt-3">
              <span className="text-[#b4b4b4] text-[15px] lg:w-[114px]"> خدمات در محل :</span>

              <select className="w-[80%] lg:w-[50%] rounded-md border border-[#d9d9d9] py-1.5 px-4 text-[#b4b4b4] text-sm">
            ...
            <div className="flex items-center justify-between lg:justify-start mt-3">
              <span className="text-[#b4b4b4] text-[15px] lg:w-[114px]">عنوان سئو :</span>
              <input
                type="text"
                className="w-[80%] lg:w-[50%] rounded-md border border-[#d9d9d9] py-1.5 px-4 text-[#b4b4b4] text-sm"
                placeholder=""
            ...
            <div className="flex items-start justify-between mt-3">
              <span className="text-[#b4b4b4] text-[15px] lg:w-[130px]"> توضیحات سئو :</span>
