  ...
  return (
    <>
      <div className="flex items-center justify-between">
        ...
        <Link to="/addServices">
          <span className="bg-[#304A59] rounded-xl px-5 py-1 gap-3 flex items-center justify-between text-[14px] text-[#fff] cursor-pointer">
            <span>+</span>
            <span>افزودن خدمات دهنده</span>
          </span>
        </Link>
      </div>
      <div className="relative flex flex-col items-center justify-between gap-2 text-[11px] text-[#596271] font-bold border-2 border-[#d8d8d8] bg-[#f6f5f1] rounded-xl l  px-4   lg:w-full mt-10 py-5">
        <div className="flex flex-col lg:flex-row w-full">
          <div className="flex items-start flex-col text-[10px]  gap-1 w-full lg:w-[25%] mt-2">
            <span>نام خدمات دهنده</span>
            <input
              type="search"
              name=""
              id=""
              className="h-[30px] bg-[#eeedeb] px-2 w-full lg:w-[80%] block rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 pr-1 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            />
          </div>
          <div className="flex items-start flex-col text-[10px]  gap-1 w-full  lg:w-[25%] mt-2">
            <span>خدمات</span>
        ...
        <div className="flex flex-col lg:flex-row w-full items-center ">
          <div className="flex items-start flex-col   gap-1 w-full  lg:w-4/12 mt-2">
            <span>شهر :</span>
            <input
              type="text"
              className="h-[30px] bg-[#eeedeb] px-2 w-full lg:w-[80%] block rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 pr-1 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
          ...
          <div className="w-full flex items-start flex-col justify-end lg:justify-center mt-4 lg:mt-0  lg:w-4/12">
            ...
            <img
              ...
              className="flex absolute bottom-[-14px] left-2 "
              alt="2"
            />
          </div>
        </div>
      ...
      <div className="w-full min-h-[402px] rounded-2xl border border-[#dbdbdb] bg-[#f9f9f9] mt-20 lg:mt-24 relative">
        <div className="hidden lg:block w-full border mt-20 border-[#d9d9d9] rounded-t-xl  bg-white min-h-[50px] ">
          <div className="overflow-x-auto ">
            ...
            <div className="w-full">
             ...
             <div className="flex flex-col lg:flex-row w-full items-center px-5">
                <div className="flex items-start flex-col   gap-1 w-full  lg:w-4/12 mt-2">
                  <span>عنوان :</span>
                  <input
                    type="text"
                    className="h-[30px] bg-[#eeedeb] px-2 w-full md:w-[80%] block rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 pr-1 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  />
                </div>
                <div className="flex items-start flex-col  gap-1 w-full  lg:w-4/12 mt-2">
                  <span>درمان :</span>
        ...
        <div className="w-full lg:hidden mt-24">
          ...
          <div className="flex flex-col items-start justify-start mt-3 px-5 gap-3 flex-wrap w-full">
            <div className="flex flex-col items-start gap-1 w-full">
              ...
              <input
                id="input1"
                type="text"
                className=" border-[#dddddc] h-[29px]  px-2  text-[11px] block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 pr-1 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
              />
            </div>
